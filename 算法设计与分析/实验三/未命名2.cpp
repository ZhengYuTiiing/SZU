...
void random_access(int size)
{
	...
	cout<<(((double)sum/1024.0) / dt)<<endl;
...
{
	int size = 64 * KB;
	vector<int> sizes{8*KB,32*KB,128*KB,256*KB,320*KB,512*KB,1024*KB,2048*KB,3072*KB,4096*KB,5120*KB,6144*KB,7168*KB,8192*KB,9216*KB,10240*KB,12000*KB,13312*KB,140000*KB,15000*KB};
